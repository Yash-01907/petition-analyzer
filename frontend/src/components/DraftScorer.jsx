  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-gray-900 mb-1">Score Your Draft</h2>
        <p className="text-sm text-gray-500 mb-6">
          Paste your campaign copy below to get a predicted conversion rate and recommendations
          before you publish.
        </p>
        ...
        <div className="space-y-4">
            ...
            <div>
              ...
              >
                {["environment", "housing", "healthcare", "education",
                  "transit", "food_security", "civil_rights", "climate"].map(c => (
          ...
          <button
            onClick={handleScore}
            disabled={loading || !form.headline || !form.body_text || !form.cta_text}
            ...
            <div className="space-y-3">
              ...
              {(!result.recommendations || result.recommendations.length === 0) && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-sm
                                text-green-700">
                  ✅ This draft scores well on all major conversion factors. Good work!
                </div>
              )}
            </div>
          </div>
